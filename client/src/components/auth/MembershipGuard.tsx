...
interface MembershipGuardProps {
  ...
  requiredFeature?: 'dashboard' | 'jobs' | 'shop' | 'discounts' | 'osecours' | 'affiliates';
  fallbackPath?: string;
}
...
const MembershipGuard: React.FC<MembershipGuardProps> = ({ 
  ...
  fallbackPath = '/membership-payment'
}) => {
            ...
            <Card className="shadow-xl border-0">
              ...
              <CardContent className="text-center space-y-6">
                <p className="text-gray-600 text-lg">
                  ...
                  Please purchase a membership card to continue.
                </p>
                
                <div className="bg-purple-50 rounded-lg p-6 space-y-4">
                  <div className="flex items-center justify-center space-x-2">
                    <Crown className="w-5 h-5 text-purple-600" />
                    <span className="font-semibold text-purple-900">Membership Benefits</span>
                  </div>
