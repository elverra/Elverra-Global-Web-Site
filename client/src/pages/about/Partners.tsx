...
import { ArrowLeft, ExternalLink, Globe, Phone, Mail } from 'lucide-react';
...
const partners = [
  ...
  },
  {
    ...
    type: 'Technology',
    description: 'Technology incubator supporting digital innovation and skills development programs.',
  ...
  },
  {
    ...
    type: 'Retail',
    description: 'Network of local businesses offering discounts and special privileges to our clients.',
  ...
  },
  {
    ...
    type: 'Education',
    description: 'Consortium of educational institutions providing training and scholarship opportunities.',
    logo: 'https://images.unsplash.com/photo-1523240795612-9a054b0db644?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80',
    services: ['Scholarships', 'Professional Training', 'Certification Programs'],
  ...
  },
  {
    ...
    type: 'Healthcare',
    description: 'Healthcare providers offering medical services and health programs to our clients.',
  ...
  },
  {
    ...
    type: 'Agriculture',
    description: 'Supporting farmers and agricultural businesses with financial services and market access.',
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Through strategic partnerships, we expand our service offerings and create more value 
                for our clients across our network.
              </p>
            </div>

            {/* Partner Categories */}
            <div className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Partner Categories</h2>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {partnerCategories.map((category) => (
                  <div key={category.name} className="text-center">
                    <Badge className={`${category.color} px-3 py-2 text-sm font-medium`}>
                      {category.name}
                    </Badge>
                    <p className="text-gray-600 text-sm mt-1">{category.count} Partner{category.count > 1 ? 's' : ''}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {partners.map((partner) => (
                <Link key={partner.id} to={`/partners/${partner.id}`} className="block">
                  <Card className="hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer h-full">
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardTitle className="text-xl text-gray-900 hover:text-purple-600 transition-colors">{partner.name}</CardTitle>
                      <p className="text-purple-600 font-semibold text-sm">{partner.partnership}</p>
                    </CardHeader>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      {/* Action Button */}
                      <div className="pt-2">
                        <Button variant="outline" size="sm" className="w-full group pointer-events-none">
                          Learn More
              ...
              <Card className="bg-purple-600 text-white">
                <CardContent className="p-8">
                  ...
                  <p className="text-purple-100 mb-6 text-lg">
                    Join our network of trusted partners and help us serve our client community better. 
                    Together, we can create more opportunities and value.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button asChild size="lg" variant="outline" className="border-white text-black hover:bg-white hover:text-purple-600">
                      <Link to={user ? "/dashboard" : "/register"}>
                        {user ? "Go to Dashboard" : "Apply to Partner"}
                      </Link>
                    </Button>
                  </div>
                </CardContent>
