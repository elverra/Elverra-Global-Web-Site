...
const translations = {
  en: {
    ...
    'register.subtitle': 'Join Elverra Global today',
    'register.email.optional': 'Email Address (Optional)',
    ...
    'register.city': 'City',
    'register.city.placeholder': 'Enter your city',
    'register.address': 'Address',
    'register.address.placeholder': 'Enter your address',
    ...
    'register.password.confirm.placeholder': 'Repeat your password',
    'register.images.title': 'Profile Images',
    'register.profile.photo': 'Profile Photo (Optional)',
    'register.profile.upload': 'Upload',
    'register.profile.format': 'JPG, PNG or WebP. Max 5MB.',
    'register.identity.card': 'Identity Card (Optional)',
    'register.identity.format': 'JPG, PNG or PDF. Max 10MB. Helps with verification.',
    'register.referral.code': 'Referral Code (Optional)',
    'register.referral.placeholder': 'Enter your referral code if you have one',
    'register.referral.locked': 'Referral code applied from shared link',
    'register.physical.card': 'Request Physical Card (Free)',
    'register.physical.description': 'Physical card will be sent after paid membership',
  ...
  fr: {
    ...
    'register.subtitle': 'Rejoignez Elverra Global aujourd\'hui',
    'register.email.optional': 'Adresse Email (Optionnel)',
    'register.email.placeholder': 'Entrez votre adresse email',
    'register.phone.placeholder': 'Entrez votre numéro de téléphone',
    'register.name.placeholder': 'Entrez votre nom complet',
    'register.city': 'Ville',
    'register.city.placeholder': 'Entrez votre ville',
    'register.address': 'Adresse',
    'register.address.placeholder': 'Entrez votre adresse',
    'register.country': 'Pays',
    'register.country.placeholder': 'Sélectionnez un pays',
    'register.password.confirm': 'Confirmer le Mot de Passe',
    'register.password.placeholder': 'Minimum 6 caractères',
    'register.password.confirm.placeholder': 'Répétez votre mot de passe',
    'register.images.title': 'Images de Profil',
    'register.profile.photo': 'Photo de Profil (Optionnel)',
    'register.profile.upload': 'Télécharger',
    'register.profile.format': 'JPG, PNG ou WebP. Max 5MB.',
    'register.identity.card': 'Carte d\'Identité (Optionnel)',
    'register.identity.format': 'JPG, PNG ou PDF. Max 10MB. Aide à la vérification.',
    'register.referral.code': 'Code de Parrainage (Optionnel)',
    'register.referral.placeholder': 'Entrez votre code de parrainage si vous en avez un',
    'register.referral.locked': 'Code de parrainage appliqué depuis le lien partagé',
    'register.physical.card': 'Demander une Carte Physique (Gratuit)',
    'register.physical.description': 'La carte physique sera envoyée après l\'adhésion payante',
    'register.button.creating': 'Création du compte...',
    'register.button.create': 'Créer le Compte',
