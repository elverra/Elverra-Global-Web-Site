                        ...
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-700 mt-1">
                              Based on your Elite client status, you're eligible for our lowest interest rate of 5%. Apply now to get funds within 24 hours.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <p className="font-medium">Valid Elverra Global Client</p>
                          <p className="text-sm text-gray-600">Active client for at least 3 months</p>
                        </div>
                      </div>
                  ...
                  <CardContent>
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            <div className="flex justify-between items-center mb-1">
                              <span className="text-sm text-gray-600">Client Tenure</span>
                    ...
                    <div className="mt-8 p-4 rounded-md bg-blue-50 border border-blue-200">
                      ...
                      <ul className="text-sm text-blue-700 space-y-1">
                        ...
                        <li>• Keep your Elverra Global client active and in good standing</li>
                        <li>• Provide additional documentation for employment verification</li>
                        <li>• Consider upgrading your client tier for better rates</li>
                      </ul>
                    </div>
                  </CardContent>
                  <CardFooter>
