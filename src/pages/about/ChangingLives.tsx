...
import { ArrowLeft, Calendar, MapPin, Quote, Star } from "lucide-react";
...
const impactStories = [
  {
    ...
    location: "Bamako",
    story:
      "Through Elverra Global's job training program, I learned digital marketing skills and landed my dream job at a tech company. The ZENIKA card helped me save on daily expenses while building my career.",
  ...
  },
  {
    ...
    story:
      "The microloan from Elverra Global helped me expand my small restaurant business. With the additional income, I was able to employ 8 local youth and support my family better.",
  ...
  },
  {
    ...
    location: "Abidjan",
    story:
      "The scholarship program allowed me to complete my computer science degree. Now I work as a software developer and volunteer to teach coding to other young women in my community.",
    category: "Education",
  ...
  },
  {
    ...
    location: "Cotonou",
    story:
      "When my family faced a medical emergency, the Ô Secours program provided immediate financial assistance. We received help within 24 hours, which made all the difference.",
  ...
  },
  {
    ...
    location: "Dakar",
    story:
      "As a single mother, the payday loan service helped me bridge financial gaps while I built my tailoring business. The flexible repayment terms made it manageable for my situation.",
    category: "Financial Support",
    impact: "Business stabilized",
    date: "2023",
    image:
      "https://images.unsplash.com/photo-1494790108755-2616b612b242?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
  ...
  },
  {
    ...
    location: "Lomé",
    story:
      "The digital library gave me access to thousands of books and courses that weren't available locally. I completed online certifications that helped me advance in my IT career.",
    category: "Education",
  ...
  },
  {
    ...
    location: "Niamey",
    story:
      "Through the agricultural support program, I modernized my farm operations and increased crop yields by 40%. The technical training and equipment loans were game-changers.",
  ...
  },
  {
    ...
    location: "Conakry",
    story:
      "The online store platform helped me reach customers beyond my local market. My handcrafted goods now sell internationally, increasing my income significantly.",
    category: "E-commerce",
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                ...
                through our services. These are the stories that inspire us to
                do more every day.
              </p>
            </div>
              ...
              <Card className="bg-purple-600 text-white">
                <CardContent className="p-8">
                  ...
                  <p className="text-purple-100 mb-6 text-lg">
                    Have you been impacted by our services? We'd love to hear
                    your story and share it to inspire others in our client
                    network.
                  </p>
