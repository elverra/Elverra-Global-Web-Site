...
const projects = [
  ...
  },
  {
    ...
    description: 'Supporting academic excellence by providing scholarships and educational resources to deserving students.',
    status: 'Active',
  ...
  },
  {
    ...
    description: 'Creating free digital libraries and learning centers to improve access to educational resources.',
    status: 'Expanding',
  ...
  },
  {
    ...
    description: 'Rapid response financial assistance program for individuals facing emergencies and urgent needs.',
    status: 'Active',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-gray-900 mb-4">Community Impact Projects</h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Through strategic partnerships and innovative solutions, we're creating positive change 
                across our client network. Here are some of our key initiatives.
              </p>
            </div>
                  ...
                  <Card className="hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer">
                    ...
                    <CardHeader>
                      <div className="flex justify-between items-start mb-2">
                        <CardTitle className="text-xl text-gray-900 hover:text-purple-600 transition-colors">{project.title}</CardTitle>
              ...
              <Card className="bg-purple-600 text-white">
                <CardContent className="p-8">
                  ...
                  <p className="text-purple-100 mb-6 text-lg">
                    Want to be part of our mission? Join us in creating positive change 
                    across our client network.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Button asChild size="lg" variant="outline" className="border-white text-black hover:bg-white hover:text-purple-600">
                      <Link to={user ? "/dashboard" : "/register"}>
                        {user ? "Go to Dashboard" : "Join Our Network"}
                      </Link>
                    </Button>
                  </div>
                </CardContent>
