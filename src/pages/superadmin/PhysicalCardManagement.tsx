...
import { CreditCard, Search, Eye, Package, Truck, CheckCircle, XCircle, Clock, Download, DollarSign } from 'lucide-react';
...
const SuperAdminPhysicalCardManagement = () => {
  ...
  const exportToCSV = async () => {
    try {
      ...
      const csvHeaders = [
        'ID', 'Full Name', 'Phone', 'Email', 'Card ID', 'Tier', 'Status', 
        'Payment Status', 'Amount', 'City', 'Country', 'Tracking', 'Created At'
      ];
      ...
      link.href = url;
      link.download = `physical-card-requests-${new Date().toISOString().split('T')[0]}.csv`;
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xl font-bold text-emerald-600">{stats.total_revenue} FCFA</p>
                  </div>
...
export default SuperAdminPhysicalCardManagement;
