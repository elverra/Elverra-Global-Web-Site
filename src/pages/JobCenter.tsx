...
const JobCenter = () => {
  ...
  useEffect(() => {
    // Mock featured jobs in absence of backend
    const sample = [
      { id: '1', title: 'Sales Manager', company: 'Elverra Global', location: 'Bamako', employment_type: 'Full-time', description: 'Lead sales team', created_at: new Date().toISOString(), featured: true },
      { id: '2', title: 'Software Engineer', company: 'TechCorp', location: 'Abidjan', employment_type: 'Contract', description: 'Build web apps', created_at: new Date().toISOString(), featured: false },
    ];
    setFeaturedJobs(sample as any[]);
  }, []);
