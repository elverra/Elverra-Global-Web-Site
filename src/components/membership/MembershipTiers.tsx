  ...
  const tiers = [
    {
      ...
      isChild: true,
      features: [
        "10% discounts at toy stores",
        "Priority access to family events",
        "Comprehensive educational programs",
        "24/7 parental support",
        "Personalized physical card included",
        "Exclusive children's activities",
        "Community support",
      ],
    },
    {
      ...
      {tiers.map((tier) => (
        ...
        >
          <div className={`${tier.color} p-4 ${tier.textColor}`}>
            ...
            <p>{tier.discount} discount on Elverra Global services</p>
          </div>
          <div className="p-4">
