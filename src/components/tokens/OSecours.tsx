...
import { TokenBalance as TokenBalanceType, ServiceType } from '@/shared/types/secours';
      ...
      >
        ...
        <TabsContent value="tokens" className="space-y-4">
          ...
          ">
            ...
            <WithdrawalRequest 
              userBalances={tokenBalances.map(balance => ({
                serviceType: balance.tokenId as ServiceType,
