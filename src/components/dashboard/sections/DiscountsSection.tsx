...
const DiscountsSection = () => {
  ...
  const fetchDiscounts = async () => {
    try {
      // Mock partner stores
      const data = [
        { id: 'st-1', name: 'Fauget Cafe', description: 'Best coffee in town', category: 'Food & Drinks', image: 'https://picsum.photos/seed/cafe/600/400', location: 'Bamako', rating: 4.6, discount: '10%', expires: '2025-12-31' },
        { id: 'st-2', name: 'Claudia Store', description: 'Trendy accessories', category: 'Clothing', image: 'https://picsum.photos/seed/store/600/400', location: 'Bamako', rating: 4.2, discount: '15%', expires: '2025-10-15' },
      ];
      setPartnerStores(data);
    } catch (error) {
      console.error('Error fetching discounts:', error);
      toast({ title: 'Error', description: 'Failed to load partner discounts', variant: 'destructive' });
    } finally {
      setLoading(false);
    }
  };
  ...
  const fetchPersonalizedOffers = async () => {
    ...
    try {
      const data = [
        { id: 'of-1', title: '10% off at Fauget Cafe', description: 'Enjoy a warm cup and save', discount: '10%', used: false, validUntil: '2025-12-31' },
      ];
  ...
  const fetchCoupons = async () => {
    ...
    try {
      const data = [
        { id: 'cp-1', code: 'ELV10', description: '10% off any purchase', discount: '10%', minSpend: 10000, expires: '2025-11-30' },
      ];
