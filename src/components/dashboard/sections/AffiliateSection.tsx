...
const AffiliateSection = () => {
  ...
  const copyReferralCode = async () => {
    ...
    try {
      ...
      toast({
        title: "Error",
        description: "Failed to copy the referral code",
        variant: "destructive",
      });
    }
  };
  ...
  const shareReferralLink = async () => {
    ...
    if (navigator.share) {
      ...
      try {
        ...
        toast({
          title: "Error",
          description: "Failed to copy the referral link",
          variant: "destructive",
        });
      }
    }
  ...
  const loadReferrals = async () => {
    ...
    try {
      ...
      // Retrieve users who have this user as a referrer
      ...
      // Now, retrieve all commissions for display
      ...
      // Retrieve corresponding profiles
      ...
      toast({
        title: "Error",
        description: "Failed to load the referral list.",
        variant: "destructive",
      });
    }
  };
  ...
  // Rely only on the affiliates table for verification
        ...
        <CardContent className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            ...
            <ul className="text-sm space-y-2 text-gray-700">
              ...
              <li>• Get paid for every card renewal and payment</li>
